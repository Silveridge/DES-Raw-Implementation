...
class SubstitutionBoxes():
    ...
    def performSubstitution(self, inputString: str):
        ...
        while index < len(sboxSplit):
            outputBinary += self.runSBox(sboxSplit[index], index)
            index += 1
    ...
    def runSBox(self, inputString: str, index: int):
        ...
        substitution = self.sboxes[index][row][column]
